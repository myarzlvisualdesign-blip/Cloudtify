...
// It MUST include <html>/<body> because it replaces the root layout.
    ...
    <html lang="id">
      <body style={{ backgroundColor: '#FAFAF8', color: '#141110', fontFamily: 'sans-serif', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', margin: 0, flexDirection: 'column', textAlign: 'center', padding: '0 24px' }}>
        ...
        <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
          <button
            onClick={() => reset()}
            style={{ background: 'linear-gradient(135deg, #1A56DB, #2B7FD4)', color: 'white', border: 'none', padding: '13px 32px', borderRadius: 12, cursor: 'pointer', fontWeight: 600, fontSize: 15 }}
          >
            Coba Lagi
          </button>
