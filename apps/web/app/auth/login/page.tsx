    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-[#FAFAF8]">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="text-[#141110] text-sm font-semibold">Password</label>
                <Link href="/auth/forgot-password" className="text-[#1A56DB] text-xs font-medium hover:opacity-75 transition-opacity">
                  Lupa password?
                </Link>
              </div>
              <div className="relative">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 text-white font-semibold py-3.5 rounded-xl text-sm
              ...
              {loading ? (
                <span className="flex items-center gap-2">
                  <svg className="animate-spin" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><circle cx="12" cy="12" r="10" strokeOpacity="0.25"/><path d="M12 2a10 10 0 0 1 10 10" strokeOpacity="1"/></svg>
                  Masuk...
                </span>
              ) : (
                <>Masuk <IcoArrowR /></>
          ...
          {/* Google */}
          <button className="w-full flex items-center justify-center gap-3 bg-white border border-[#E5E2DD]
          ...
          <p className="text-center text-[#A8A29E] text-sm mt-7">
            Belum punya akun?{' '}
            <Link href="/auth/register" className="text-[#1A56DB] font-semibold hover:opacity-75 transition-opacity">
              Daftar gratis
            </Link>
          </p>
        </div>
